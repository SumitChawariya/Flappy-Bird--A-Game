...
class Bird:
    ...
    #- When we redraw the bird on the game screen, we draw the wing-up or the wing-down image, to create the "flapping" effect
...
class PipePair:
    ...
    #then, pipesSpace
    #- score_counted tells us if we passed through the pipes succesfully and we received the points
